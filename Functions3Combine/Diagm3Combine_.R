...
# Diagm3Combine_
# Input: X_split, Diag_split as the sub-features.
# Output: The merged features

# This file works for 3D data with its target at 2D features.

Diagm3Combine_ <- function(X_split,m,Diag_split,
                          gap1,gap2,gap3,maxdimension,maxscale){
  # Find the ind_suspicious and ind_subfeature as index of showing embryonic features and features that away from boundary.
  ...
  # Retrieve the representative data from the sub-features
