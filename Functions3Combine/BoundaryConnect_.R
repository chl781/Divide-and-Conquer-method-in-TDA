...
# This function constructs the distance matrix among supplemental boundaries.
# This function targets at the case of 3D data with the aim of maxdimension=2 features.
BoundaryConnect_ <- function(i1,j1,k1,n1,dist1,dist2,dist3){
  # i1,j1,k1 is the index of the sub-region.
  # dist1, dist2, dist3 is the length of the sub-region as squares.
